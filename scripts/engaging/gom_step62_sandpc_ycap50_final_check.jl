...
length(ARGS) == 5 || error(
    "Usage: gom_step62_sandpc_ycap50_final_check.jl " *
...
const SANDPC_EXPECTED_REGIONS =
    GoMStep62SandPcYCap50Contract.EXPECTED_QOI_REPORTING_REGIONS
const SANDPC_EXPECTED_INTERFACES =
    GoMStep62SandPcYCap50Contract.EXPECTED_QOI_INTERFACES
...
issubset(
    GoMStep62SandPcYCap50Contract.REQUIRED_QOI_INTERFACES,
    interface_ids
...
completion["primary_label_sha256"] ==
    GoMStep62SandPcYCap50Contract.EXPECTED_QOI_PRIMARY_LABEL_SHA256 ||
...
println(
    "STEP62_SANDPC_YCAP50_QOI_FINAL_CHECK_PASS " *
