...
diagnostics =
    GoMStep62SandPcYCap50Contract.validate_assembled_case((; case, mrst))
...
function vtu_cell_array_names(path)
    ...
    occursin(
        "NumberOfCells=\"$(GoMStep62SandPcYCap50Contract.EXPECTED_CELLS)\"",
        header
...
open(summary_path, "w") do io
    ...
    println(
        io,
        "fault_pc_adjusted_tables=$(diagnostics.pc_summary["adjusted_tables"])"
    )
